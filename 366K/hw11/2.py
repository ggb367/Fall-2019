...
r_0 = [lagrange[1, 0], lagrange[1, 1], 0]  #this will change depending on the initial conds
v_0 = [0, 0, 0]
r_vec, v_vec = sf.CRTBP_prop_rk(r_0, v_0, 0, tf, dT, mu)  # propogate in CRTBP Frame
